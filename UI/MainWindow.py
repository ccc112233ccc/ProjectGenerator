...
class MainWindow(QMainWindow):
    def __init__(self,global_config_path='globalconfig.json'):
        ...
        self.global_config = json.load(open(global_config_path, 'r',encoding='utf-8'))
        ...
        # 加载结构图片
        self.structure_paths = self.global_config.get('structure', {}).get('structure_path', [])
    ...
    def init_ui(self):
        ...
        self.tree_editor = EditableTreeWidget(self.global_config['config']['file_path'])
        ...
        self.structure_dock.setFeatures(QDockWidget.DockWidgetClosable)  # 只允许关闭
        ...
        self.structure_dock.visibilityChanged.connect(self.update_structure_action)
    ...
    def create_menu(self):
        ...
        # TreeEditor 显示/隐藏
        self.toggle_tree_action = QAction('显示/隐藏 Tree Editor', self, checkable=True)
        ...
        self.toggle_structure_action = QAction('显示/隐藏 Structure Viewer', self, checkable=True)
        self.toggle_structure_action.setChecked(True)
        self.toggle_structure_action.triggered.connect(self.toggle_structure_dock)
    ...
    def run_executable(self):
        ...
        self.log_widget.add_log(f"开始执行: {self.executable_path} {' '.join(self.executable_args)}")
